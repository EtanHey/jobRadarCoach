...
await writeFile(resolve(target,"app/page.tsx"), 'import { JobBoard } from "@/components/job-board"; export default function Page() { return <><div style={{background:"#8b2d18",color:"white",padding:6}}>DEVELOPMENT FIXTURES — synthetic postings and coordinates</div><JobBoard /></> }');
console.log(target);
