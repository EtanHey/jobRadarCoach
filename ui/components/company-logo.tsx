...
export function CompanyLogo({ company, className }: CompanyLogoProps) {
  ...
  return <span className={frame}><Image unoptimized src={src} alt={`${company} logo`} width={44} height={44} className="size-full object-contain p-1" onError={() => setFailedSrc(src)} /></span>;
}
